...
import re
from OpenAI.openaiClient import ask_ai_for_values
from OpenAI.ollama import  ask_ollama_to_generate_values
BASE_DIR = Path(__file__).parent
RULES_JSON = BASE_DIR / "resource"/"rules"/ "pacs.008.001.13_rules.json"
SKELETON_XML = BASE_DIR /"resource"/"skeleton"/ "CstmrCdtTrfTraceFormat_skeleton.xml"
...
def generate_value(rule):
    ...
    x=ask_ollama_to_generate_values(rule)
    print(x)
